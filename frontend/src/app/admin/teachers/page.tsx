            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-400">
                        Manage teacher profiles, subject specializations, and contact info.
                    </p>
                </div>
                    ...
                    <table className="min-w-full divide-y divide-[var(--glass-border)]">
                        <thead className="bg-[rgba(255,255,255,0.05)]">
                            <tr>
                                ...
                                <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-white">Qualification</th>
                        ...
                        <tbody className="divide-y divide-[var(--glass-border)] bg-[rgba(255,255,255,0.02)]">
                            {loading ? (
                                <tr>
                                    <td colSpan={5} className="text-center py-4 text-gray-400">Loading teachers...</td>
                                </tr>
                            ) : filteredTeachers.length === 0 ? (
                                <tr>
                                    <td colSpan={5} className="text-center py-4 text-gray-400">No teachers found.</td>
                                </tr>
                            ) : (
                                filteredTeachers.map((teacher) => (
                                    <tr key={teacher.id} className="hover:bg-[rgba(255,255,255,0.05)] transition-colors">
                                        ...
                                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-300">{teacher.qualification || '-'}</td>
                                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-300">{teacher.phone_number || '-'}</td>
                    ...
                    <div className="bg-[var(--background-dark)] border border-[var(--glass-border)] rounded-xl p-6 w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleCreateTeacher} className="space-y-6">
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-300">Subject Specialization</label>
                                    <input
                                        type="text"
